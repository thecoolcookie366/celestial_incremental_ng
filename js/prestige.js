addLayer("p", {
    ...
    upgrades: {
        ...
        13: {
            title: "EVIL Prestige Upgrade III",
            unlocked() { return true },
            description: "Unlocks Factor VII. Maybe.",
            cost: new Decimal("1e1.1e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
        ...
        10: {
            title: "EVIL Prestige Upgrade IV",
            unlocked() { return true },
            description: "Multiply Factor Effect Base by x1.2.",
            cost: new Decimal("1e1.2e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
        ...
        14: {
            title: "EVIL Prestige Upgrade V",
            unlocked() { return true },
            description: "The long awaited upgrade you've been waiting for! You can buy max ranks, tiers, and tetr",
            cost: new Decimal("1e1.3e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
        ...
        15: {
            title: "EVIL Prestige Upgrade VI",
            unlocked() { return true },
            description: "Autobuys factors I-VIII. You were expecting this, right?",
            cost: new Decimal("1e1.4e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
        ...
        17: {
            title: "EVIL Prestige Upgrade VIII",
            unlocked() { return hasUpgrade("p", 16) },
            description: "Automates rank gain. That actually means you're going to Infinity...",
            cost: new Decimal("1e2.25e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
        ...
        18: {
            title: "EVIL Prestige Upgrade IX",
            unlocked() { return hasUpgrade("p", 17) },
            description: "Automates tier gain. You should've already broken infinity, or you're here without buying max ranks/tiers/tetrs.",
            cost: new Decimal("1e2.5e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
        ...
        19: {
            title: "EVIL Prestige Upgrade X",
            unlocked() { return hasUpgrade("p", 18) && (tmp.f.buyables[26].unlocked || hasUpgrade("p", 19)) },
            description: "Unlocks Power Factor VIII, and more tree buyables. Like that's going to do anything?",
            cost: new Decimal("1e2.75e59"),
            currencyLocation() { return player.p },
            currencyDisplayName: "Prestige Points",
            currencyInternalName: "prestigePoints",
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
