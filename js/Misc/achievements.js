addLayer("achievements", {
    ...
    achievements: {
        ...
        3: {
            ...
            tooltip: "<h3>Real Doubling</h3><hr style='margin-bottom:4px'>Reach x2 points from factors.",
            color: "white",
            complete() {return hasUpgrade("p", 15) || hasUpgrade("cs", 201)},
            unlocked: true,
        },
        4: {
            name: "Tetr, What's a Mino?",
            image: "resources/achievements/1_04.png",
            tooltip: "<h3>Tetr, What's a Mino?</h3><hr style='margin-bottom:4px'>Obtain your first tetr.<br><br>Reward: Ranks and Tiers are<br>e1.79e308x, respectively 1.79e308x cheaper.",
            color: "white",
